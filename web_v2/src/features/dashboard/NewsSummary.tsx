...
export default function NewsSummary({ accounts, entries }: Props) {
  ...
  return (
    <div className="rounded-xl border bg-card p-4 sm:p-5 flex flex-col">
      ...
      {/* Chat button */}
      <button
        onClick={() => navigate({ to: '/chatbot/operation' })}
        className="mt-4 w-full flex items-center justify-center gap-2 rounded-xl border bg-primary/5 hover:bg-primary/10 text-primary text-sm font-medium py-2.5 transition-colors"
      >
